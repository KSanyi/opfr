...
import hu.kits.opfr.common.CollectionsUtil;
...
public class JdbiUtil {
    ...
    private static void executeUpdate(Jdbi jdbi, String tableName, Map<String, Object> originalMap, Map<String, Object> updatedMap, Map<String, String> keysWithValues) {
